                ...
                >
                  ...
                  <div className="mt-2 flex items-center gap-2 text-[10px] text-gray-400 flex-wrap">
                    ...
                    {realRisks.slice(0, 2).map(r => (
                      <span key={r.riskType} className={`inline-flex items-center rounded-full px-1.5 py-0.5 text-[9px] font-medium ${r.severity === 'high' ? 'bg-red-100 text-red-700' : r.severity === 'medium' ? 'bg-amber-100 text-amber-700' : 'bg-gray-100 text-gray-600'}`}>
